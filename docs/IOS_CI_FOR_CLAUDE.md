...
**Current bundle ID:** `com.kulitorum.decenza` (set in CMakeLists.txt line 429)
...
- **Bundle ID**: `com.kulitorum.decenza` (different from Android's `io.github.kulitorum.decenza_de1`)
- **Team ID**: `HKHN2RK2P4`
